    ...
    <div className="rounded-xl overflow-hidden shadow-lg bg-white hover:shadow-2xl transition-shadow duration-300">
      <div className="relative overflow-hidden group">
        ...
        <div className="absolute bottom-3 left-0 right-0 px-4 ">
          <button className="bg-transparent opacity-0 group-hover:backdrop-blur-md group-hover:opacity-100  border  text-white font-bold w-full py-2 rounded-lg shadow-md transition-all duration-300 transform hover:scale-105">
            More Info
          </button>
        </div>
      </div>
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-gray-200">
          ...
          <div className="flex items-center text-gray-600">
            ...
            <span className="text-sm font-medium">{numberOfLike}</span>
          </div>
        </div>
      </div>
    </div>
